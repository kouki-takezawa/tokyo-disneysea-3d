...
- **PC**: マウスでドラッグすると見回せる(カメラだけが回り、キャラクターの向きは変わらない)。W A S D / 矢印キーでカメラの向きを基準に歩き(1.4 m/秒)、キャラクターは進む方向を向く。Shift で走る(4 m/秒)。V キーで一人称(目の高さ 1.58 m)と三人称を切り替える。Esc で俯瞰に戻る。
